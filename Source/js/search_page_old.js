...
function fn_draw_category_tree(){
    $.ajax({
        ...
        success: function(result){
            ...
            if(result.length > 0){
                var html = '';
                html += '<li><div class="item_open cls_child_node cls_active_item" style="cursor: pointer;"><a class="item_open" id="aaa'+result[0]["id"]+'"></a><span id='+result[0]["id"]+'>'+result[0]["name"]+'</span></div>';
